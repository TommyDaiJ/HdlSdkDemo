...
2.1.1 `compile(name: 'hdl_lib-v1.2.1', ext: 'aar')`此种方式依赖为aar文件依赖，此arr包为HDL Lib的通讯包。可向相关开发人员索取最新arr包，`compile 'com.hdl.lib:hdllib:1.2.0'`此种方式与aar包依赖方式同样效果（详情请看demo）
